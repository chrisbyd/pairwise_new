...
python train.py --dataset sysu --lr 0.01  --drop 0.0 --trial 1 --gpu 0  --lamda1 1 --lamda2 0.1 --lamda3 0.05 --method 'sc' --mode 'indoor'
python train.py --dataset sysu --lr 0.01  --drop 0.2 --trial 1 --gpu 0  --lamda1 1 --lamda2 0.01 --lamda 0.05 --method 'sc' --mode 'indoor'
