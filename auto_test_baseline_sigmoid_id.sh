...
python train.py --dataset sysu --lr 0.01  --drop 0.0 --trial 1 --gpu 0  --lamda1 1 --lamda2 0.01 --lamda3 0.02 --method 'sc' --mode 'indoor'
python train.py --dataset sysu --lr 0.01  --drop 0.5 --trial 1 --gpu 0  --lamda1 0 --lamda2 1 --method 'sc' --mode 'indoor'
